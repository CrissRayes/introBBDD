...
INSERT INTO nombre_tabla (columna1, columna2, columna3) -- para insertar datos a una tabla
VALUES (valor1, valor2, valor3);

SELECT * FROM nombre_tabla; -- ver la estructura que tiene nuestra tabla


UPDATE nombre_tabla SET columna1=valor_nuevo WHERE condicion; -- actualizar registros existentes

DROP TABLE tabla; -- eliminar toda la tabla
...
\i ubicación\nombre_fichero.sql -- cargar desde un fichero
...
-- FULL OUTER JOIN
-- Este tipo de unión nos permite obtener todos los registros disponibles en las tablas 
-- que estamos relacionando, sin filtrar la información.
SELECT columnas
FROM tabla1
